...
void AGEPlugin::procesar(TDS *tds)
{
        ...
        fprintf( f, "<PlayerGeneration>\n"
                    "<Template id=\"20000000\" name=\"Nuestro H�roe\" "
...
void KenshiraPlugin::procesar(TDS *tds)
{
        ...
        fprintf( f, "\n\tvar DescLarga = \"T� eres el protagonista.\"\nendobject\n\n" );
...
void InPawsPlugin::procesar(TDS *tds)
{
        ...
        fprintf( f, "SUBCHAR \"�\" \"{144}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{148}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{152}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{158}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{159}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{147}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{149}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{150}\";\n" );
        fprintf( f, "SUBCHAR \"�\" \"{151}\";\n" );
        fprintf( f, "#endif\n\n" );
